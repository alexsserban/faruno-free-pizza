        ...
        <table class="w-full text-left">
            <thead>
                <tr>
                    ...
                    <th v-if="isTableForToday" class="px-4 py-2 text-sm font-bold uppercase border-b text-th">
                        Actions
                    </th>
                </tr>
            </thead>
            <tbody>
                <tr
                    ...
                    :key="index"
                >
                    <td v-for="(elem, index) in tableElements" :key="index" class="px-4 py-4 text-sm border-b text-te">
                        {{ order[elem] }}
                    </td>
                    ...
                    <td v-if="isTableForToday" class="border-b">
                        <div v-if="isPendingOrder(order) || isEditOrder(order)">
                            <button
                                ...
                                :class="order.status == 'completed' ? 'opacity-50 cursor-not-allowed' : ''"
                            ...
                            <button
                                ...
                                :class="order.status == 'cancelled' ? 'opacity-50 cursor-not-allowed' : ''"
